...
✏️ **Update Employee**: Modify employee details like phone number, address, or shift location.
🗑️ **Remove Employee:** Delete employee records when they leave the company or change stores.
📄 **Fetch Employee Details:** View all employees working under a specific store.
